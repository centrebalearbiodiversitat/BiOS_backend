...
Reemplaza "PROYECTO-ID" por código del ticket de Notion  en el que estás trabajando. Para ello deberás utilizar el nombre del proyecto al que pertenece el ticket seguido de su ID. Por ejemplo:

![Ejemplo de ticket](assets/images/example_ticket.jpg)

En este caso, deberías de llamar a tu rama "BIODUMPY-38".

>Nota :eyes:
> 
>Ten en cuenta que la numeración del ID de cada ticket no es consecutiva en relación a su proyecto, es decir, siguiendo el ejemplo anterior, "BIODUMPY-38" no significa que sea el ticket número 38 que se ha creado para el proyecto BIODUMPY, si no que del total de tickets creados para todos los proyectos, al momento de crear dicho ticket para ese proyecto se generó el ID nº38.
...
**<font color="BF4458">tipo</font>** -> Indica el tipo de cambio que se ha realizado. Algunos tipos comunes son:
...
- **<font color="BF4458">style</font>**: Cambios de estilo (espaciado, formato, etc.)
...
- **<font color="BF4458">chore</font>**: Tareas de mantenimiento (build, configuración, etc.)
